...
| [mpd2mpris](https://github.com/b0bbywan/mpd2mpris) | ![Python](https://img.shields.io/badge/Python-3776AB?logo=python&logoColor=white) | MPRIS2 bridge for MPD — asyncio + dbus-fast rewrite, python-mpd2, systemd |
